package com.example.vj.tugas_06;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickButton (View view){
        final TextView X = (TextView) findViewById(R.id.hasilX);
        final TextView Y = (TextView) findViewById(R.id.hasilY);
        Button Kanan = (Button) findViewById(R.id.button3);
        Button Kiri = (Button) findViewById(R.id.button2);
        Button Atas = (Button) findViewById(R.id.button);
        Button Bawah = (Button) findViewById(R.id.button4);
